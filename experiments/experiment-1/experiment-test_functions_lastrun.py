...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Maik Bieleke\\My Drive\\Labor\\psychopy-apparatus\\experiments\\experiment-1\\experiment-test_functions_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    while continueRoutine and routineTimer.getTime() < 60.0:
        ...
        if apparatusForce_2.status == STARTED:
            ...
            if tThisFlipGlobal > apparatusForce_2.tStartRefresh + 60-frameTolerance:
    ...
    thisExp.addData('apparatusForce_2.rate', 100)
    thisExp.addData('apparatusForce_2.device', 'both')
    thisExp.addData('apparatusForce_2.maxWhiteForce', apparatusForce_2.maxWhiteForce)
    thisExp.addData('apparatusForce_2.maxBlueForce', apparatusForce_2.maxBlueForce)
    if True:
